...
def save_object(file_path, obj):
    try:
        ...
        with open(file_path, "wb") as file_obj:
            ...
            # pickle.dump(obj, file_obj) serializes obj into the file using pickle’s default protocol 
            # (which may not be the most efficient). After this line obj is saved to disk as a binary blob.
